...
<html lang="en">
   ...
   ?>
      ...
      <main id="main" class="main">
         <div class="pagetitle">
            <h1>All Equipment Records</h1>
            <nav>
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                  <li class="breadcrumb-item active">Equipments Records</li>
               </ol>
         ...
         <div class="card-body mb-4">
                         ...
                         <!--<form action="equipment_excel.php" method="post">
                        ...
                        <div class="text-end my-4">
                           <input type="text"  id="search_input" oninput="get_bookings_equipment(this.value)" class="form-control shadow-none w-25 ms-auto" placeholder="Type to search..">
                        </div>
...
function get_bookings_equipment(search='',page=1){
        
        let xhr = new XMLHttpRequest();
        xhr.open("POST","./ajax/bookings_records_equipment.php",true);
            xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
    
            xhr.onload = function(){
                let data = JSON.parse(this.responseText);
                document.getElementById('table-data-equipment').innerHTML = data.table_data;
                document.getElementById('table-pagination').innerHTML = data.pagination;
            }
            xhr.send('get_bookings_equipment&search='+search+'&page='+page);
    ...
    function change_page(page){
      get_bookings_equipment(document.getElementById('search_input').value,page);
    }
