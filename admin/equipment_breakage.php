      ...
      <main id="main" class="main">
         ...
         <div class="card-body mb-4">
                        ...
                        <div class="text-end my-4">
                           <input type="text"  id="search_input" oninput="get_breakage_equipment(this.value)" class="form-control shadow-none w-25 ms-auto" placeholder="Type to search.." >
                        </div>
                           ...
                           <table class="table table-hover" style="min-width:200px;">
                            ...
                            <tbody id="equipment_breakage_data">
...
function get_breakage_equipment(search='',page=1){
        
        let xhr = new XMLHttpRequest();
            xhr.open("POST","./ajax/equipment_breakage_ajax.php",true);
            xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
    
            xhr.onload = function(){
                let data = JSON.parse(this.responseText);
                document.getElementById('equipment_breakage_data').innerHTML = data.table_data;
                document.getElementById('table-pagination').innerHTML = data.pagination;
            }
            xhr.send('get_breakage_equipment&search='+search+'&page='+page);
