...
<head>
    ...
    <title>Inventory and Borrowing Management System</title>
...
<form class="form_container" method="POST" autocomplete="off">
  <div class="logo_container">
    <img src="../img/csmlogo.png" alt="">
  </div>
  <div class="title_container">
    <p class="title">Inventory and Borrowing Management System</p>
  ...
  <div class="input_container">
    ...
    <input placeholder="Email" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field"  >
  </div>
  <div class="input_container">
  ...
  <button title="Sign In" type="submit" class="sign-in_btn" name="login">
    <span>Sign In</span>
  </button>
  ...
  <?php 
    ...
    
    {
        ...
        $values = [$frm_data['input-name'],$frm_data['input-password']];
